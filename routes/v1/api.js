...
router.post('/drone/arm', checkAuthenticate, droneService.arm)
router.post('/drone/disarm', checkAuthenticate, droneService.disarm)
router.post('/drone/takeoff', checkAuthenticate, droneService.takeOff)
router.post('/drone/land', checkAuthenticate, droneService.land)
router.post('/drone/goto', checkAuthenticate, droneService.goTo)
router.post('/drone/changeflightmode', checkAuthenticate, droneService.changeFlightMode)
router.post('/drone/changespeed', checkAuthenticate, droneService.changeSpeed)
router.post('/drone/changeyaw', checkAuthenticate, droneService.changeYaw)
router.post('/drone/servocontrol', checkAuthenticate, droneService.servoControl)
router.post('/drone/gimbalcontrol', checkAuthenticate, droneService.gimbalControl)
